...
4. Keep features inside their own folder.
5. Respect role-based access. Import roles from `src/lib/auth/roles.js`, never hardcode role strings.
...
8. Follow the Borders Law and Layer Primitives Law from the root `CLAUDE.md`.
...
| Task touches…                                                        | Read                      |
| -------------------------------------------------------------------- | ------------------------- |
| Project identity, stack                                              | rules/project.md          |
| UI, tokens, `staffglobal.css`                                        | rules/ui.md               |
| File placement                                                       | rules/file-structure.md   |
| Auth, roles, Keycloak                                                | rules/permissions.md      |
| Supabase, schema                                                     | rules/database.md         |
| Presentation mode                                                    | rules/presentation.md     |
| Build, lint, tests                                                   | rules/testing.md          |
| Installed agent skills, Codex/Claude skill loading, `.agents/skills` | rules/skills.md           |
| User prompt shortcuts                                                | rules/prompt-shortcuts.md |
