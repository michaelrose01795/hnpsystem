...
//
// Phase 10 — Developer Platform "Notifications". A history of platform
// notifications (with severity signalling via tone/background tint, never a
// coloured side-border) plus subscription-rule management: team-default rules
// (owner_key "*") are read-only, personal rules can be toggled, created and
// removed. Strictly gated to the Developer Platform roles. CLAUDE.md compliant.
