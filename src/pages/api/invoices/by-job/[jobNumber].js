...
async function handler(req, res) { // main handler for /api/invoices/by-job/[jobNumber]
...
export default withRoleGuard(handler); // invoice tab is available to every authenticated job-card user
