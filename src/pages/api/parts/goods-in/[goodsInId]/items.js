  ...
  if (req.method === "POST") {
    ...
    try {
      const payload = {
        ...
        manufacturer_part_number: cleanText(manufacturerPartNumber),
        description: cleanText(description),
        bin_location_primary: cleanText(binLocationPrimary),
        bin_location_secondary: cleanText(binLocationSecondary),
