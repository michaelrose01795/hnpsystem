...
export default function CreateJobCardPage() {
  ...
  const handlePaymentTypeChange = (index, value) => {
    ...
    // If Warranty is selected, automatically set Job Source to Warranty
    if (value === "Warranty") {
      setJobSource("Warranty");
    }
  ...
  const handleSaveJob = async () => {
    ...
    const jobCardData = {
      ...
      vehicle,
      customer,
      requests: validRequests.map((r) => ({ text: r.text, time: r.time, paymentType: r.paymentType })),
      cosmeticNotes,
      vhcRequired,
      waitingStatus,
      jobSource,
  ...
  const handleFetchVehicleData = async () => {
    ...
    try {
      ...
      if (manufacturingData) {
        ...
        setVehicleDataSource("DVLA/Manufacturing Data");
      ...
      setVehicleDataSource("Mock Data (Testing)");
        ...
        >
          ...
          <button
            ...
            onMouseOver={(e) => {
              ...
              e.target.style.boxShadow = "0 6px 10px rgba(40,167,69,0.3)";
            }}
            onMouseOut={(e) => {
              e.target.style.backgroundColor = "#28a745";
              e.target.style.boxShadow = "0 4px 6px rgba(40,167,69,0.2)";
            }}
          >
            Save Job
          </button>
