...
export default function Appointments() {
  ...
  // isLoading is true only on the very first load with no cached data — used to
  // show skeleton rows inside the day-jobs table while the shell renders instantly.
  const { jobs: allJobs, isLoading: jobsLoading, mutate: mutateJobs } = useJobsList({ enabled: !!user });
