...
// so every direct child card/section is a <LayerTheme> (depth 1), and any strip
// nested inside a section flips back to <LayerSurface> (depth 2). Shared pure
// formatters live in ./historyFormat (also used by the Service History tab).
...
/* ════════════════════════════════════════════════════════════════════════
   WarrantySummary — top summary cards for a linked claim. The wrapper is plain
   layout so the stat cards sit directly on the warranty panel as LayerTheme
   cards using the --theme background.
   ════════════════════════════════════════════════════════════════════════ */
const AUTH_OPTIONS = [
