        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            ...
            <tr
              ...
              style={{ borderBottom: "1px solid var(--separating-line-color)", background: hoveredTransactionId === txn.transaction_id ? "rgba(var(--primary-rgb), 0.12)" : "var(--surface)", transition: "background-color 0.18s ease" }}>
