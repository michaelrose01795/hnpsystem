// file location: src/components/dev-platform/sections/ActivitySection.js
//
// Phase 10 content, Phase 11 extraction — "Activity & Audit" view. Reads the
// dev-gated activity feed (/api/support/activity), which shapes the hash-chained
// audit_log into a timeline plus a coverage roll-up of the expected developer
// actions. Read-only surface; all data comes from the API. Rendered by both the
// standalone /dev/activity page and the Support hub's "Activity" tab.
