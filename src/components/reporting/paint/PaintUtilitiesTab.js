// file location: src/components/reporting/paint/PaintUtilitiesTab.js
//
// Reporting Utilities: saved views, exports, filters and drill-down explorer for
// the Paint package. Exports use the audited reporting export API.
...
import { ALL_EXPORTABLE, PAINT_VIEW_TARGET } from "./paintReportConfig";
import { reportDevKey } from "../reportDevOverlay";

export default function PaintUtilitiesTab({ filter, onApplySavedView }) {
