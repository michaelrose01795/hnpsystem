// file location: src/components/reporting/accounts/AccountsUtilitiesTab.js
//
...
// and Parts packages — no duplicate implementation. Every export of financial
// data is permission-gated and audited server-side.
...
import { ALL_EXPORTABLE, ACCOUNTS_VIEW_TARGET } from "./accountsReportConfig";

export default function AccountsUtilitiesTab({ filter, onApplySavedView }) {
