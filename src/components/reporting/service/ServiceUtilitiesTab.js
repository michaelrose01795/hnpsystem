// file location: src/components/reporting/service/ServiceUtilitiesTab.js
//
...
// Parts / Accounts packages — no duplicate implementation.
...
import { ALL_EXPORTABLE, SERVICE_VIEW_TARGET } from "./serviceReportConfig";
import { reportDevKey } from "../reportDevOverlay";

export default function ServiceUtilitiesTab({ filter, onApplySavedView }) {
