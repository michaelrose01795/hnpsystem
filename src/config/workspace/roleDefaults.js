...
export const ROLE_WORKSPACE_DEFAULTS = Object.freeze({
  ...
  "parts": layout(
    mod("department-general", ["/newsfeed", "/messages"]),
    mod("department-management", ["/archive"]),
    mod("department-parts", ["/dashboard/parts", "/order", "/new-order", "/stock-catalogue", "/deliveries", "/goods-in"]),
  ),
  "parts manager": layout(
    mod("department-general", ["/newsfeed", "/messages"]),
    mod("department-management", ["/dashboard/managers", "/archive"]),
    mod("department-parts", ["/dashboard/parts", "/parts-manager", "/order", "/new-order", "/stock-catalogue", "/deliveries", "/goods-in"]),
