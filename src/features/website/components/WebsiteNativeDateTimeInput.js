// file location: src/features/website/components/WebsiteNativeDateTimeInput.js
...
export default function WebsiteNativeDateTimeInput({
  ...
  return (
    <div
      ref={rootRef}
      className="website-native-datetime"
    ...
    >
      ...
      >
        <span
          className={
            selectedLabel
              ? "website-native-datetime__value"
              : "website-native-datetime__placeholder"
          }
        >
          {displayLabel}
        </span>
