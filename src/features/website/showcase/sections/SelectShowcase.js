...
export default function SelectShowcase({ section }) {
  ...
  return (
    <ShowcaseSection id="select" section={section}>
      <Row label="WebsiteNativeSelect" note="live · click to open">
      ...
      <Row label="Open menu" note="selected · active · hint · plain">
      ...
      <Row label="Empty menu" note=".website-native-select__empty">
        <div className="website-dev-menu-frame">
      ...
      <Row label="Shared Dropdown API" note="@family dropdown · staff DropdownField under the customer scope">
        <div className="website-dev-cluster">
          <div className="website-dev-menu-frame">
            <div className="dropdown-api is-open">
              ...
              <span className="dropdown-api__helper">Helper text under the control</span>
            </div>
          </div>
          <div className="website-dev-menu-frame">
            <div className="dropdown-api">
              <span className="dropdown-api__label">Placeholder state</span>
