        ...
        <div className="app-page-stack">
          ...
          <div className="app-section-card" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              ...
              <div data-slideshow="create-submit"><PrimaryBtn>Save Job Card</PrimaryBtn></div>
            </div>
          </div>
          ...
          <div className="app-section-card" style={{ display: "flex", flexWrap: "wrap", gap: 16, padding: 0, background: "transparent", border: "none", boxShadow: "none" }}>
            ...
            <div className="app-section-card" style={{ flex: "1 1 260px", display: "grid", gap: 12 }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 6 }} data-slideshow="create-reg-lookup">
            ...
            <div className="app-section-card" style={{ flex: "1 1 260px", display: "grid", gap: 12 }} data-slideshow="create-customer-lookup">
...
function AppointmentsMock() {
  ...
  return (
    <div className="app-page-stack" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div className="app-section-card" style={{ display: "grid", gridTemplateColumns: "repeat(4, minmax(0, 1fr))", gap: 8, alignItems: "center", background: "rgba(220,38,38,0.10)" }}>
      ...
      <div style={{ display: "flex", gap: 12, alignItems: "stretch" }}>
        ...
        <div style={{ flex: "1 1 auto", borderRadius: 8, overflow: "hidden", background: "var(--surface, #fff)" }}>
        ...
        <div className="app-page-card" style={{ flex: "0 0 40%", background: "var(--surfaceMuted, rgba(0,0,0,0.02))", padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
...
function JobDetailMock() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      {/* Header Section */}
      <section style={{ display: "flex", flexDirection: "column", gap: "12px", padding: "20px", backgroundColor: sharedShell, borderRadius: "var(--radius-sm)", border: "none", flexShrink: 0 }} data-slideshow="job-detail-status">
      ...
      {/* Tabs */}
      <section style={{ backgroundColor: "transparent", borderRadius: 0, padding: 0 }} data-slideshow="job-detail-tabs">
  ...
  const vhcSummaries = [
    {
      ...
      technician: "Demo Tech A",
      overall: "amber",
      items: [
        { name: "Front RH tyre", status: "amber", detail: "3.1mm — monitor" },
        { name: "Front pads",    status: "amber", detail: "4mm — advise" },
        { name: "Brake fluid",   status: "red",   detail: "Moisture 4.2% — change" },
      ],
    },
    {
      id: "vhc-demo-002",
...
function PartsGoodsInMock() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "18px", padding: "12px" }}>
      ...
      <section className="app-section-card invoice-details-section" style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <section className="app-section-card add-part-section" style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
...
function PartsDeliveriesMock() {
  ...
  return (
    <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "20px" }}>
      <section className="app-section-card" style={{ gap: "16px" }}>
      ...
      <section className="app-section-card" style={{ gap: "14px" }}>
...
function HrDashboardMock() {
  ...
  return (
    <div className="app-page-stack" style={{ padding: "8px 8px 32px" }}>
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "var(--layout-card-gap)" }}>
        {metrics.map((m) => (
