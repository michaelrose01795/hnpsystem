...
const MAX_COMPONENTS_PER_SECTION = 60;
...
const SYMPTOM_GROUPS = {
  ...
  tyre: [
    ...
    {
      id: "tyre_damage",
      phrases: ["cut", "sidewall damage", "puncture"],
      severityAllowed: ["Amber", "Red"],
      actionsAllowed: ["replace", "repair"],
      actionByPhrase: { cut: "replace", "sidewall damage": "replace", puncture: "repair" },
      symptomPriority: 8,
      notesTemplates: ["inspect casing integrity"],
    },
  ],
  defaultMechanical: [
    {
