...
const SECTIONS = [
  ...
  { id: "sales-2", label: "Sales 2", type: "sales", isPhysicalMapArea: true, capacity: 17, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 40, aliases: ["service yard"] },
  { id: "sales-3", label: "Sales 3", type: "sales", isPhysicalMapArea: true, capacity: 30, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 50, aliases: ["stock compound", "compound"] },
  { id: "sales-4", label: "Sales 4", type: "sales", isPhysicalMapArea: true, capacity: 20, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 60, aliases: [] },
  { id: "sales-5", label: "Sales 5", type: "sales", isPhysicalMapArea: true, capacity: 40, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 70, aliases: [] },
  { id: "sales-6", label: "Sales 6", type: "sales", isPhysicalMapArea: true, capacity: 40, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 80, aliases: [] },
  { id: "sales-7", label: "Sales 7", type: "sales", isPhysicalMapArea: true, capacity: 35, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 90, aliases: ["rear car park a", "rear a", "overflow", "overflow west fence"] },
  { id: "sales-8", label: "Sales 8", type: "sales", isPhysicalMapArea: true, capacity: 15, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 100, aliases: ["rear car park b", "rear b"] },
  ...
  { id: "staff", label: "Staff", type: "staff", isPhysicalMapArea: true, capacity: 35, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 130, aliases: ["staff parking", "employee parking"] },
  { id: "trade", label: "Trade", type: "trade", isPhysicalMapArea: true, capacity: 20, capacityConfirmed: true, supportsAutoMovement: false, displayOrder: 140, aliases: ["trade parking", "container storage", "container", "containers"] },
  {
    id: "paint",
    label: "Paint",
    type: "building",
