// file location: src/singlescroll/shop/CancelPage.js
    ...
    <ShopShell title="Checkout cancelled">
      <div className="ws-card" style={{ padding: 30, textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "center", marginTop: 20 }}>
          <a href="/website/shop/cart" className="ws-btn ws-btn--primary">
            Return to cart
          </a>
          <a href="/website#shop" className="ws-btn ws-btn--ghost">
            Continue shopping
          </a>
        </div>
      </div>
