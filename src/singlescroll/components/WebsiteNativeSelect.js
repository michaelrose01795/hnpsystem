// file location: src/singlescroll/components/WebsiteNativeSelect.js
...
export default function WebsiteNativeSelect({
  ...
  return (
    <div
      ref={rootRef}
      className={`${styles.wsRoot} website-native-select`}
    ...
    >
      ...
      <button
        type="button"
        className={`${styles.wsTrigger} website-native-select__trigger ${className}`}
        disabled={disabled}
      ...
      >
        <span
          className={
            selected
              ? `${styles.wsTriggerValue} website-native-select__value`
              : `${styles.wsTriggerPlaceholder} website-native-select__placeholder`
          }
        >
          {displayText}
        </span>
