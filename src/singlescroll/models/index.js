// file location: src/singlescroll/models/index.js
// Catalog of every Suzuki glTF model used by the public single-scroll
...
// singlescroll feature folder so the model list lives next to the
