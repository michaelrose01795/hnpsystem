-- supabase/perf/03-after-snapshot.sql
--
-- READ-ONLY. Run this in the Supabase SQL editor (or psql) AFTER changing
-- anything, and keep the output. It is the "after" half of the measurement
-- window.
--
